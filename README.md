...
On the overview of your hosted service use the "Quick Connect" button to select ypur way of connecting the online hosted service for your local backend app or run it in PostgreSQL, Nodejs Development or DBeaver.
